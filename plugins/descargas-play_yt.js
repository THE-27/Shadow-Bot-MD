...
await conn.sendFile(m.chat, imgUrl, 'error.jpg', `
「✦」ძᥱsᥴᥲrgᥲᥒძ᥆ » *『${yt_play[0].title}』*

*ⴵ ძᥙrᥲᥴі᥆ᥒ »* *${secondString(yt_play[0].duration.seconds)}*
*⇄ㅤ     ◁   ㅤ  ❚❚ㅤ     ▷ㅤ     ↻*

> *⧒ 𝑬𝒔𝒑𝒆𝒓𝒆 𝒖𝒏 𝒎𝒐𝒎𝒆𝒏𝒕𝒐, 𝒆𝒏 𝒍𝒐 𝒒𝒖𝒆 𝒆𝒏𝒗í𝒐 𝒔𝒖 𝒂𝒖𝒅𝒊𝒐 *`, m);
try {
...
> *⧒ 𝑬𝒔𝒑𝒆𝒓𝒆 𝒖𝒏 𝒎𝒐𝒎𝒆𝒏𝒕𝒐, 𝒆𝒏 𝒍𝒐 𝒒𝒖𝒆 𝒆𝒏𝒗í𝒐 𝒔𝒖 𝒗𝒊𝒅𝒆𝒐*`, m);
try {
...
> *⧒ 𝑬𝒏𝒗𝒊𝒂𝒏𝒅𝒐 𝒆𝒍 𝒂𝒖𝒅𝒊𝒐 𝒆𝒏 𝒅𝒐𝒄𝒖𝒎𝒆𝒏𝒕𝒐, 𝒂𝒈𝒖𝒂𝒓𝒅𝒆𝒏 𝒖𝒏 𝒎𝒐𝒎𝒆𝒏𝒕𝒐 𝒑𝒐𝒓 𝒇𝒂𝒗𝒐𝒓....*
`.trim();
...
> *⧒ 𝑬𝒏𝒗𝒊𝒂𝒏𝒅𝒐 𝒆𝒍 𝒗í𝒅𝒆𝒐 𝒆𝒏 𝒅𝒐𝒄𝒖𝒎𝒆𝒏𝒕𝒐, 𝒂𝒈𝒖𝒂𝒓𝒅𝒆𝒏 𝒖𝒏 𝒎𝒐𝒎𝒆𝒏𝒕𝒐 𝒑𝒐𝒓 𝒇𝒂𝒗𝒐𝒓....*
`.trim();

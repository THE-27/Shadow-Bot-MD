...
text: `⚔️ ¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} Coins ⛀* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} Coins ⛃* a ${senderName}.`,
contextInfo: { 
...
conn.reply(m.chat, `😒 No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} Coins ⛀* a ${senderName}.`, m, rcanal)
break
case 2:

...
conn.reply(m.chat, `${emoji2} ¡Hola! Soy Shadow-Bot, en que puedo ayudarte hoy?\n\n✰ Usa *!menu* para ver la lista comandos.`, m, rcanal, )
}
...
if (!chat.isBanned && m.text.match(/(te amo|teamo|te amo bot|te amo shadow)/gi)) {

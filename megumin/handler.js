...
m.exp += xp
if (plugin.estrellas && global.db.data.users[m.sender].estrellas < plugin.estrellas * 1) {
m.reply(`No tienes suficiente ${moneda} para usar este comando.`) 
continue
}
...
if (m.estrellas)
conn.reply(m.chat, `❮✦❯ Utilizaste *${+m.estrellas}* ${moneda} ⛃`, m)
}
if (m.money)
conn.reply(m.chat, `❮⚡❯ Utilizaste *${+m.money}* ${moneda} ⛂`, m)
break
}}} catch (e) {
console.error(e)
} finally {
...
unreg: '✩₊˚.⋆☾⋆⁺₊✧.✩₊˚.⋆𝕽𝖊𝖌𝖎𝖘𝖙𝖗𝖔⋆.˚₊✩.✧₊⁺⋆☾⋆.˚₊✩\n✦⫘⫘⫘⫘❁︩︪•°ֺ໋۪݊🌸°໋•︪︩❁⫘⫘⫘⫘✦\n『✦』 ¡ℍ𝕖𝕪! 𝕟𝕠 𝕖𝕤𝕥𝕒𝕤 𝕣𝕖𝕘𝕚𝕤𝕥𝕣𝕒𝕕𝕠/𝕒, 𝕣𝕖𝕘𝕚𝕤𝕥𝕣𝕖𝕤𝕖 𝕡𝕒𝕣𝕒 𝕦𝕤𝕒𝕣 𝕖𝕤𝕥𝕒 𝕗𝕦𝕟𝕔𝕚𝕠𝕟*\n\n*/reg nombre.edad*\n\n*_❕ Ejemplo_* : \n> » *#reg thenla.19*\n ۬︵࣪᷼⏜݊᷼⏜࣪᷼✿⃘𐇽۫ꥈ࣪࣪࣪࣪࣪࣪࣪𝇈⃘۫ꥈ࣪࣪࣪࣪࣪𑁍ٜ𐇽࣪࣪࣪࣪࣪𝇈⃘۫ꥈ࣪࣪࣪࣪࣪✿݊᷼⏜࣪᷼⏜࣪᷼︵۬ ',
